...
pacman_script() {
sudo pacman -Syu
cd ~/cider_install_scripts/Linux/Pacman
...
sudo rm ~/cider_install_scripts/Linux/Pacmancider-v3.0.0-linux-x64.pkg.tar.zst
cd ~/
exit 0
}
...
dnf_script() {
sudo dnf upgrade
cd ~/cider_install_scripts/Linux/DNF
sudo rpm --import https://repo.cider.sh/RPM-GPG-KEY
sudo mv ~/cider_install_scripts/Linux/DNF/cider.repo /etc/yum.repos.d
sudo dnf makecache
